...
namespace cli_life
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Reset(configuration);
            configuration.LoadState(board, "C:\\Users\\Makskyreer\\Desktop\\mod-lab04-life-b34\\save.txt");
            while (true)
            {
                Console.Clear();
                Render();
                configuration.SaveState(board, "C:\\Users\\Makskyreer\\Desktop\\mod-lab04-life-b34\\save.txt");
                board.Advance();
                Thread.Sleep(1000);
            }
